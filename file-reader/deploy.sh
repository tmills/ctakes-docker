...
export UIMA_CLASSPATH=/apache-uima-as-2.10.3/lib/:reader.jar:/apache-ctakes-4.0.0/lib/

# Call the java code to write the descriptor:

./runRemoteAsyncAE.sh -p 10  failover:https://$broker_host:$broker_port mainQueue -d desc/localDeploymentDescriptor.xml  -c desc/FilesInDirectoryCollectionReader.xml
